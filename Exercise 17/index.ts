...
let friends = invitation.pop()
console.log(` Sorry MR ${friends} You Are Not Invited`)

let friends1 = invitation.pop()
console.log(` Sorry MR ${friends1} You Are Not Invited`)

let friends2 = invitation.pop()
console.log(` Sorry MR ${friends2} You Are Not Invited\n`)

for (let i = 0; i < invitation.length; i++){
    console.log(`MR ${invitation} you are still invited`)
}
