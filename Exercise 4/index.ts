...
const myQuote: string = `"Elon Musk once said, “When something is important enough, you do it even
if the odds are not in your favor"`

console.log(myQuote);

//Print:
//"Elon Musk once said, “When something is important enough, you do it even
//if the odds are not in your favor"